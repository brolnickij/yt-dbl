...
class Settings(BaseSettings):
    ...
    transcription_max_chunk_minutes: float = Field(default=30.0, ge=5.0, le=120.0)
    ...
    # Max segments per translation API call. For long audio (>1h) the
    ...
    translation_max_tokens: int = Field(default=32768, ge=1024, le=65536)
